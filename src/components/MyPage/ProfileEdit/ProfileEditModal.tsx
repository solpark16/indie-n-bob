  ...
  return (
    <div className="fixed inset-0 flex items-center justify-center bg-black bg-opacity-50">
      <div className="bg-white p-8 rounded-xl w-full max-w-xl relative">
        {/* 상단 배경 */}
        <div className="absolute top-0 left-0 right-0 bg-[#10AF86] h-12 rounded-t-xl flex justify-end items-center p-4">
        ...
        {/* 헤더 */}
        <h1 className="text-2xl font-semibold mb-6 text-center text-[#10AF86] mt-12">프로필 수정</h1>
        ...
        <div className="flex justify-center space-x-4 px-16">
          ...
          <button className="flex-1 px-4 py-2 bg-[#10AF86] text-white rounded hover:bg-[#10AF86]/80">
            완료
          </button>
        </div>
      </div>
