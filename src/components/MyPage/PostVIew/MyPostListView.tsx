...
const MyPostListView = () => {
  ...
  return (
    <div className="space-y-4">
      {posts.map((post) => (
        <div key={post.post_id} className="post-container flex items-start space-x-4 p-4 ease-in-out duration-400 transition-transform transform hover:-translate-y-2">
